...
public class Nivel4 extends javax.swing.JFrame {
     ...
     */
    public Nivel4(String[][] tableroIn, String[][] posicionesIn, int filaPosicionesIn) {
        initComponents();
        labels();
        addKeyListener(new Nivel4.TAdapter());
        setFocusable(true);
        tablero = tableroIn;
    ...
    public void tableroInicial(String[][] tablero, String[][] posiciones) {
        ...
        tablero[Integer.parseInt(posiciones[3][0])][Integer.parseInt(posiciones[3][1])] = "C";
